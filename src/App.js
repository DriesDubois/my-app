...
function App() {
  return (
    <>
      <nav class="text-center bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
          <a href="https://flowbite.com/" class="flex items-center">
            <img src="public\maskable_icon_x128.png" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
      ...
      <h1 class="text-center mt-10 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We invest in the world’s potential</h1>
      ...
      {/* <div class="flex justify-center items-center mb-5">
        <a onClick={()=>skipwaiting} href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
          Skip waiting
